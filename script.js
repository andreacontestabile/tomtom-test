$(document).ready(function () {
  ...
  var userInput = $("#test").val();

  userInput = "Piazza del Popolo, Roma";

  $.ajax({
    "url": "https://api.tomtom.com/search/2/search/" + userInput + ".json",
    "method": "GET",
    "data": {
    ...
    "success": function (data) {
      ...
      renderMap(lon, lat);
      createMarker('place.colors-white.svg', [lon, lat], '#5327c3', 'SVG icon');
